...
@class PRedPacketParticipant;
@class PSendRedPacketInfo;
@class PWalletGiftInfo;
...
/// 列表
@property(nonatomic, readwrite, strong, null_resettable) NSMutableArray<PDiamondInfo*> *listArray;
...
/// 列表
@property(nonatomic, readwrite, strong, null_resettable) NSMutableArray<PRedPacketInfo*> *listArray;
/// The number of items in @c listArray without causing the array to be created.
@property(nonatomic, readonly) NSUInteger listArray_Count;
...
/// 抢红包参与者
@property(nonatomic, readwrite, strong, null_resettable) NSMutableArray<PRedPacketParticipant*> *listArray;
/// The number of items in @c listArray without causing the array to be created.
@property(nonatomic, readonly) NSUInteger listArray_Count;
...
@property(nonatomic, readwrite, strong, null_resettable) NSMutableArray<PWalletGiftInfo*> *listArray;
/// The number of items in @c listArray without causing the array to be created.
@property(nonatomic, readonly) NSUInteger listArray_Count;
